    ...
    return MaterialApp(
      ...
      body: Column(
          children: <Widget>[
            ...
            Row(children: <Widget>[
              TextButton(onPressed: _addMarkers, child: Text("添加标注点")),
              TextButton(onPressed: _addTextOptionsList, child: Text("添加文本信息")),
            ]),
            Row(children: <Widget>[
              TextButton(onPressed: _addPolylineOptions, child: Text("画折线")),
              TextButton(onPressed: () => _controller.clearMap(), child: Text("清除图层")),
            ]),
            Row(children: <Widget>[
              TextButton(onPressed: _startLocation, child: Text("开始定位")),
              TextButton(onPressed: _requestLocation, child: Text("单次定位")),
              TextButton(onPressed: _stopLocation, child: Text("停止定位")),
            ]),
            Row(children: <Widget>[
              TextButton(onPressed: _convert, child: Text("转换坐标")),
              TextButton(onPressed: _convertList, child: Text("转换坐标列表")),
            ]),
            Row(children: <Widget>[
              TextButton(onPressed: _getDistance, child: Text("计算距离")),
              TextButton(onPressed: _calculateArea, child: Text("计算面积")),
            ]),
            TextButton(onPressed: _getNearestPointFromLine, child: Text("返回某点距线上最近的点")),
            TextButton(onPressed: _isCircleContainsPoint, child: Text("判断圆形是否包含传入的经纬度点")),
            TextButton(onPressed: _isPolygonContainsPoint, child: Text("返回一个点是否在一个多边形区域内")),
          ],
        ),
    ));
  }
